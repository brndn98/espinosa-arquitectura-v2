    ...
    <div class="wrapper">
        ...
        <div class="services-wrapper">
            ...
            <div class="services-header-2">
                ...
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint, impedit quam nostrum repellat veritatis ad officiis molestiae suscipit, rerum inventore cumque.
                </p>
                <a id="services-contact" onclick="openContact()">CONTACTANOS</a>
            </div>

            <div class="services-summary">
                <h1>We count with a selected variety of services</h1>
                <div class="services-summary-service">
                    <h1>SERVICE ONE</h1>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio cumque vitae porro, nam nulla dolorum eum eaque tempora eligendi doloribus harum corporis eos perferendis consequuntur id aut, nisi aliquid illum.
                    </p>
                </div>
                <div class="services-summary-service">
                    <h1>SERVICE TWO</h1>
                    <p>
                       Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita adipisci corporis aliquid aut illo, quis perferendis quisquam ullam, quae impedit ipsum sit enim alias assumenda! Facere ducimus ullam porro saepe. 
                    </p>
                </div>
                <div class="services-summary-service">
                    <h1>SERVICE THREE</h1>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim voluptates harum laudantium quidem nostrum consequatur officiis quisquam architecto id sunt esse, perferendis odit minima temporibus? Alias non deserunt suscipit ex.
                    </p>
                </div>
            </div>

            <div class="construction-br services-img"></div>

            <div class="services-construction">
                <div class="construction-img services-img" style="background-image: url(images/services/loaded/services_02.jpg); grid-area: con1;"></div>
                <div class="construction-img services-img" style="background-image: url(images/services/loaded/services_10.jpg); grid-area: con2;"></div>
                <div class="construction-img services-img" style="background-image: url(images/services/loaded/services_11.jpg); grid-area: con3;"></div>
                <div class="construction-info">
                    <!--<h1>Lorem ipsum dolor sit amet consectetur adipisicing elit</h1>-->
                    <h1>Construcción y mantenimiento</h1>
                    ...
                    <p>Construcción residencial, Construcción industrial, Albañilería general, Mantenimiento industrial, Instalaciones hidráulicas, Instalaciones eléctricas, Calculo estructural, HVAC, Construcción en acero, Montaje de naves y bodégas, Soldadura y Paileria, Canceleria</p>
                </div>
                <div class="construction-img services-img" style="background-image: url(images/services/loaded/services_12.jpg); grid-area: con4;"></div>
            </div>

            <div class="architecture-br services-img"></div>

            <div class="services-architecture">
                <div class="architecture-img services-img" style="background-image: url(images/services/loaded/services_00.jpg); grid-area: arc1;"></div>
                <div class="architecture-img services-img" style="background-image: url(images/services/loaded/services_08.jpg); grid-area: arc2;"></div>
                <div class="architecture-info">
                    <h1>Diseño y planificación</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec bibendum risus erat, eu tincidunt odio gravida sit amet. Cras arcu tellus, aliquet nec tortor vel, varius bibendum tortor.</p>
                </div>
                <div class="architecture-img services-img" style="background-image: url(images/services/loaded/services_01.jpg); grid-area: arc3;"></div>
            </div>

            <div class="services-br services-img"></div>
